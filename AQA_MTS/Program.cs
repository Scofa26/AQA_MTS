...
*/
            ...
            double mean1 = sum3 / 5.0;
            double mean2 = sum4 / 5.0;

            if (mean1 == mean2) Console.WriteLine("Средние арифметические равны ");
            else if (mean1 > mean2) Console.WriteLine("Для 1-го массива ср.а. больше ");
